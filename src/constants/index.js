...
export const mySocials = [
  {
    name: "WhatsApp",
    href: "https://api.whatsapp.com/send/?phone=%2B94786495906&text&type=phone_number&app_absent=0",
    icon: "/assets/socials/whatsApp.svg",
  },
  {
    name: "Linkedin",
    href: "https://www.linkedin.com/in/ashen-dissanayake-372985216",
    icon: "/assets/socials/linkedIn.svg",
  },
  {
    name: "Instagram",
    href: "https://www.instagram.com/ashendiz?igsh=OHB2NWoyNzNzdHdt&utm_source=qr",
...
export const experiences = [
  
  {
    ...
    job: "Less Taxi Pvt Ltd",
    date: "2025-Present",
    contents: [
      "🪐 Designed end-to-end UI/UX for the Less Taxi paging application, focusing on usability, accessibility, and modern design principles",
      "🪐 Converted UI/UX designs into fully functional frontend interfaces",
      "🪐 Collaborated with stakeholders to align design decisions with business and user needs",
      "🪐 Ensured responsive design and smooth user interactions across devices"
    ],
  },
 {
    title: "Intern Software Engineer",
    job: "Virtual System Pvt Ltd",
    date: "2024-2025",
    contents: [
      "🪐Developed a full-stack web-based application tailored for small and medium enterprises (SMEs) to streamline inventory and sales management.",
      "🪐 Designed and implemented core modules: user, customer, and product management (CRUD operations).",
      "🪐 Built secure login system using JWT authentication and bcrypt password hashing (no registration).",
      "🪐 Developed invoicing module with customer/product selection, quantity input, and automatic stock deduction.",
      "🪐 Engineered responsive React frontend with structured navigation (main and sub menus).",
      "🪐 Designed MySQL database schema with relational integrity and foreign key constraints.",
    ],
  },
  // {
